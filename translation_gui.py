...
# Pr3209 language numbers from the Syntec Confluence language table.
# CHT uses the default-language value; the extended table also lists 118.
PR3209_LANGUAGE_NUMBERS = {
    'CHT': 1,
    'ARA': 100,
    'ARI': 101,
    'ARE': 102,
...
class TranslationApp:
    ...
    def update_lang_display(self):
        ...
        for lang, info in sorted(display_langs.items()):
            ...
            chk = ttk.Checkbutton(
                self.lang_frame,
                text=f"{PR3209_LANGUAGE_NUMBERS[lang]} - {lang} - {info['name']}",
                variable=var
            )
